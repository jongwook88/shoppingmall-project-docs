...
![목차](https://github.com/jungeunlee95/shoppingmall-project-docs/raw/master/3%EC%A3%BC%EC%B0%A8/assets/1564572874402.png)
...
| 상품 하위 옵션 가져오기                              | /getlowoption/{productNo}       | 07.21    | 5h (5시간)   | 07.20    | 3h (3시간) |                                                              |
| 특정 조건(카테고리, 검색어)에<br> 맞는 상품 가져오기 | /{categoryNo}?keyword={keyword} | 07.22    | 5h (5시간)   | 07.20    | 3h (3시간) |                                                              |
